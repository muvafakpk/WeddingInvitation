        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {parents.map((parent, index) => (
            ...
            >
              ...
              <div className="mx-auto mt-6 h-px w-16 bg-gradient-to-r from-transparent via-[#d4af37] to-transparent" />
              <p className="mt-6 font-[Cormorant_Garamond] text-xl leading-9 text-slate-700">{parent.names[0]}</p>
