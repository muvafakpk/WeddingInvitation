  ...
  return (
    <section className="px-4 py-20 sm:px-6 lg:px-8">
      <motion.div
        ...
        className="mx-auto max-w-5xl rounded-[2rem] border border-[#D0B16A]/25 bg-[#FFF8EE] p-10 text-center text-[#2b2a28] shadow-[0_24px_70px_rgba(0,0,0,0.1)]"
      >
        ...
        <p className="mt-8 font-[Amiri] text-3xl leading-[2.3] sm:text-4xl">
          وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُمْ مِنْ أَنفُسِكُمْ أَزْوَاجًا
        </p>
        <p className="mt-6 font-[Poppins] text-lg italic text-[#4d4638]/90">
